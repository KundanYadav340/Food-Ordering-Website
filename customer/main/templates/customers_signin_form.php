...
<!--	<h1>Parag canteen</h1>-->
	...
	<div class="login-box">
        ...
        <h2>Parag Canteen</h2><br>
		<form id="login" class="input-group" action="../processes/customers_signin_process.php" method="post">
			<!--<label><span><strong>Email:</strong></span></label>--><br>
			<input type="email" class="input-field" placeholder="email" name="user" required autocomplete="off"><br><br>
		...
		Don't have account? <a href="customers_registration_form.php">create an account</a><br><br>
	</div>
    </center>
</body>
</html>