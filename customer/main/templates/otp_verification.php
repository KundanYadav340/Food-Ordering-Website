  ...
  content="width=device-width, initial-scale=1, maximum-scale=1"/> 
            ...
            <body>
                <div id ="redirect">
                    Great........<br>
                    <p>
                    Your account is created now you can enjoy your orders. We are eagerly waiting to help you...
                    </p>
                    <i>Will you take a moment to give us opportunity to guide you through this application ? <br></i>
                    <a href="guide.php">yes guide me</a><br><br><br>
                   <a href="index.php"> <button id="home"> Go to home page</button> </a>
                </div>
                	<div id="place">
            	...
            	<script type="text/javascript">
	            	...
	            	function verift(){
		            	...
		            	$.ajax({
				        	url:"../processes/customers_registration_process.php",
				        	method:"post",
