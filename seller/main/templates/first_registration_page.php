...
<body>
	...
	<div class="login-box">
		...
		<form id="login" class="input-group" action="seller_otp_verification.php" method="post">
			...
			<input type="text" class="input-field" placeholder="full name" name="username" required autocomplete="off" minlength="5"><br>
			
		<!--	<label><span><strong>E-mail:</strong></span></label><br>-->
			<input type="email" class="input-field" placeholder="e-mail" name="e-mail"  autocomplete="off" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Enter valid email"><br>
		...
		<!--	<label><span><strong>Password:</strong></span></label><br>-->
			<input id="pass" type="password" class="input-field" placeholder="Password" name="password"  required autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"><br>
			
			
		  <!-- <label><span><strong>Confirm Password:</strong></span></label><br>-->
			<input id="cpass"  class="input-field" placeholder="confirm password" name="confirm-password" required autocomplete="off" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" >
