...
<body>
	...
	<div class="login-box">
		...
		<form id="login" class="input-group" action="seller_otp_verification.php" method="post">
			...
			<input id="name" type="text" class="input-field" placeholder="restaurant name" name="username" required autocomplete="off" minlength="4"><br>
			
		<!--	<label><span><strong>E-mail:</strong></span></label><br>-->
			<input id="description" type="text" class="input-field" placeholder="description" name="description"  autocomplete="off" minlength="4" title="Enter valid description"><br>
			
		<!--	<label><span><strong>Phone number:</strong></span></label><br>-->
			<input id="location" type="text" class="input-field" placeholder="restaurant location" name="location" required autocomplete="off"><br>
    ...
    <script type="text/javascript">
    	...
    	$.ajax({
				        	url:"../processes/seller_second_registration_process.php",
				        	method:"post",
				        	data:{name:name,description:description,location:location},
				        	success: function (result){
					                                	if(result=="1"){
					                                	      window.location.assign("third_registration_page.php");
					                                	}else{
